  ...
  return (
    <div className="relative max-w-[392px]   ">
      ...
      <Link href={`/offer/${deal.id}`} className="relative">
        ...
        <div className="absolute left-[2%] bottom-[3%]  w-[90px] max-w-[110px]  z-50 rounded-[12px]  h-[124px] font-sans bg-highlight text-primary text-center border">
        ...
        <div className="absolute left-[33%] bottom-[1%]   z-50 rounded-[12px]  w-[70%] max-w-[70%]  h-[135px] text-white    ">
          <div className="flex flex-col ">
            ...
            {/* priceBefore with line-through */}
            <Button className=" bg-white text-primary  transition flex justify-center items-center   font-bold mt-1 py-2  mx-4 ">
              <span>Book Now</span>
            </Button>
          </div>
        </div>
